...
/**
 * Stolen from MvRx's RealMvRxStateStore - https://github.com/airbnb/MvRx
 *
 ...
 *
 */
class MvRxViewState<S : Any>(initialState: S) {
    /**
    ...
    fun isDisposed() = disposables.isDisposed
